...
SECRET_KEY = 'django-insecure-s#=26os@+9tl_q(a)#n#^ji5wfqhu#1wd!6swu7khl_(3@19pg'
...
AUTH_USER_MODEL='autherization.NormalUser'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'autherization.context_processors.add_feedback',
